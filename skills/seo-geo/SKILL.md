...
- **Scored content audit (80-item CORE-EEAT):** `content-quality-auditor`
- **AI-citation optimization:** `geo-content-optimizer`
- **Title/meta/OG and JSON-LD:** `serp-markup-builder`. Prefer it over the templates above; it tracks the rich-result deprecations.
- **AdSense push end to end:** `adsense-content-pipeline`. When it drives the work, its precedence rules win over this skill's GEO tactics and percentage claims.
